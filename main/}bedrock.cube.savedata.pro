601,100
602,"}bedrock.cube.savedata"
562,"NULL"
586,
585,
564,
565,"i=dlr`Q1haOf9LYb]vCkS[a\LTl1xyWLTpdxQlshnSMX=Nstc1Hayn1u@s<fF>K0p:lkRuzgp8KwARUm?r3Kavz<8Y_0PIzHh;HS[Y`KVlRHDJe0jF1kt2u<IjUS;le@JpN?oRkNH8ZwycoXLQ_>=KgEsRuxdlbjMOu0Z<:5F6a<8^Hh1DqO\It:8Nrk2B[2HDe<IRMe"
559,1
928,0
593,
594,
...
If( 1 = 0 );
    ExecuteProcess( '}bedrock.cube.savedata', 'pLogOutput', pLogOutput,
	    'pCube', '', 'pDelim', '&'
    );
EndIf;
